...
const NotificationsPage: React.FC = () => {
  ...
  return (
    <div className="flex bg-[#0a0a0a] min-h-screen text-zinc-300 font-mono">
       <Sidebar />
          ...
          <header className="flex flex-col md:flex-row md:items-end justify-between gap-6 pb-8 border-b border-[#2e2e2e] relative overflow-hidden">
              <div className="flex flex-col gap-3 z-10 transition-all">
                <div className="flex items-center gap-3">
                   ...
                   <span className="text-[10px] font-black uppercase tracking-[0.4em] text-zinc-500 italic">Sector_Alert_Archive</span>
                </div>
              ...
              <div className="flex gap-4 z-10">
                 <Button 
                   ...
                   variant="outline" 
                   className="bg-[#111] border-zinc-800 text-[10px] font-black uppercase italic gap-2 rounded-none hover:bg-zinc-900 border-[#6366f1] text-[#6366f1]"
                 >
                 ...
                 <Button 
                   ...
                   variant="outline"
                   className="bg-[#111] border-zinc-800 text-[10px] font-black uppercase italic gap-2 rounded-none hover:bg-red-950 hover:border-red-500 text-zinc-500 hover:text-red-500"
                 >
          ...
          <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 pt-4">
             <Tabs value={filter} onValueChange={(v) => { setFilter(v as any); setPage(1); }}>
                <TabsList className="bg-[#111] border border-zinc-900 rounded-none h-12 p-1 gap-1">
                   <TabsTrigger value="all" className="text-[9px] font-black uppercase italic tracking-widest px-8">All_Transmissions</TabsTrigger>
                   <TabsTrigger value="unread" className="text-[9px] font-black uppercase italic tracking-widest px-8">Unread_Only</TabsTrigger>
                </TabsList>
             </Tabs>
             ...
             <div className="flex items-center gap-3 bg-[#111] border border-zinc-900 p-1">
                ...
                <span className="text-[10px] font-black uppercase italic text-zinc-400 px-4">Cycle_Page 0{page}</span>
                <Button 
             ...
             {isLoading ? (
                ...
                <div className="flex-1 flex flex-col items-center justify-center p-32 opacity-20 grayscale grayscale-0 space-y-6">
                   ...
                   <div className="flex flex-col items-center text-center gap-2">
                     <h2 className="text-2xl font-black uppercase tracking-[0.2em] italic">Archive_Empty</h2>
                     <p className="text-[10px] font-black uppercase tracking-widest text-[#F97316]">Caught Up on Sector Protocols_</p>
                   </div>
                </div>
             ) : (
